...
import { driveAuth, hasArchiveAuth } from '@/pages/api/auth'
...
async function handler (req: NextApiRequest, res: NextApiResponse): Promise<void> {
	...
	try {
		if (req.method === 'GET') {
			...
			const tree = process.env.DEVELOPMENT_TREE_FILE ? await getDevelopmentTree() : await loadAndBuildTree(auth, folderId, res)
